...
%                         end_pt1 = [prev_land(large_land_ndx,5) - r_len, prev_land(large_land_ndx,6)];
%                         end_pt2 = [prev_land(large_land_ndx,5) + r_len, prev_land(large_land_ndx,6)];
%                     else %%% 90 degree orientation
%                         end_pt1 = [prev_land(large_land_ndx,5), prev_land(large_land_ndx,6) - r_len];
%                         end_pt2 = [prev_land(large_land_ndx,5), prev_land(large_land_ndx,6) + r_len];
%                     end
%                     prev_land(large_land_ndx,1) = end_pt1(1);
%                     prev_land(large_land_ndx,2) = end_pt1(2);
%                     prev_land(large_land_ndx,3) = end_pt2(1);
%                     prev_land(large_land_ndx,4) = end_pt2(2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
